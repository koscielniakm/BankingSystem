...
public class DaoFactory {
	...
	public static IncomingMoneyTransferDao getIncomingMoneyTransferDao() {
	...
	public static OutgoingMoneyTransferDao getOutgoingMoneyTransferDao() {
		return new OutgoingMoneyTransferDaoImpl();
	}
